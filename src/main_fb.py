...
from dataloader_fb import DataLoaderFB, Batch
...
def validate(model: Model, loader: DataLoaderFB, line_mode: bool) -> Tuple[float, float]:
    """Validates NN."""
    print('Validate NN')
...
def main(args):
    ...
    if args.mode in ['train', 'validate']:
        ...
        loader = DataLoaderFB(args.data_dir, args.batch_size, fast=args.fast)
